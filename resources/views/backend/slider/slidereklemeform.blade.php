...
@section('content')
        <div class="col-md-12">
            ...
            <div class="card card-primary">
                ...
                <form action="{{ route('.admin.slider.insertform')  }}" method="POST" enctype='multipart/form-data' role="form">
                    {{ csrf_field() }}
                    <div class="card-body">
                        <div class="form-group">
                            <label for="exampleInputEmail1">Slider Baslik</label>
                            <input name="slider_baslik" type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter email">
                        </div>
